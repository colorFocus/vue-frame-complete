...
UE.I18N['en'] = {
    ...
    'music':{
        'static':{
            ...
            'lang_upload_deletebtn':"delete",
            'lang_upload_allerror':'Can't upload',
        },
        'errorExceedSize':'File Size Exceed',
        'errorServerUpload':'The server returned an error and the frontend was abnormal.',
        'errorInterrupt':'File Upload Interrupted',
        'errorHttp':'Http Error',
        'errorFileType':'File Type Not Allow',
        'errorUploadRetry':'Upload Error, Please Retry.',
